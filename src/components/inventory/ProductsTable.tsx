...
import { ChevronsUpDown, ChevronsRight, ChevronsLeft, ChevronRight, ChevronLeft, Ellipsis, Settings2, Upload } from "lucide-react"
...
interface ProductsTableProps {
    ...
    onEditLinks?: (product: Product) => void
    onUploadImage?: (product: Product) => void
}

export function ProductsTable({ onEditProduct, onEditLinks, onUploadImage }: ProductsTableProps) {
    ...
    const handleUploadImage = (product: Product) => {
        if (onUploadImage) onUploadImage(product)
    }
                    ...
                    return (
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                                ...
                                <DropdownMenuItem onClick={() => { handleUploadImage(row.original) }}>
