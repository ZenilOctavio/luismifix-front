...
import { ECOMMERCE_PAGE_PATHNAME, HOME_PAGE_PATHNAME, INVENTORY_PAGE_PATHNAME, PRODUCTS_HISTORICAL_PAGE_PATHNAME, PROVIDERS_PAGE_PATHNAME } from './config/constants'
